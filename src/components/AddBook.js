  ...
  return (
    <div className="container p-3">
      <form className="t-border pt-3" onSubmit={handleSubmit}>
        ...
        <label htmlFor="title" className="col-4 me-2">
        ...
        <label htmlFor="category" className="col-4 ms-2">
          <select className="col-5" name="category" placeholder="Author name" id="category" value={book.category} onChange={handleChange}>
          ...
          <button className="c-white-two bc-azure ms-1 col-5" type="submit">ADD BOOK</button>
        </label>
      </form>
    </div>
  );
